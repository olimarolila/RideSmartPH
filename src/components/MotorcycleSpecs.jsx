...
function MotorcycleSpecs() {
    ...
    const paginatedMotorcycles = motorcycles.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
                        ...
                        savedBikes.map((bike, index) => (
                            <div key={index} className="card motorcycle-card bookmarked">
                                <div className="d-flex justify-content-between align-items-start">
                                    ...
                                    <i className="bi bi-x-circle text-danger ms-2" style={{ fontSize: '1.2rem', cursor: 'pointer' }} title="Remove bookmark" onClick={(e) => { e.stopPropagation(); handleRemove(bike);}}></i>
                                </div>
                            </div>
                        ))
                    ) : (
