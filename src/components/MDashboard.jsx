        ...
        return (
            <div className="mileage-arc">
                <svg width="100" height="100" viewBox="0 0 36 36">
                    ...
                    <circle cx="18" cy="18" r="16" fill="none" stroke={color} strokeWidth="3" strokeDasharray={strokeDasharray} strokeDashoffset="25" transform="rotate(-90 18 18)" />
                    <text x="50%" y="50%" textAnchor="middle" dominantBaseline="middle" fontSize="6" fill={color}>
                        {value}km
                    </text>
                </svg>
                {value >= 5000 && (
        ...
        <div className="dashboard-container">
            ...
            <form className="maintenance-form">
                <label>Last Change Oil:
                    <input type="date" name="changeOil" value={maintenanceData.changeOil} onChange={handleChange} />
                </label>
                <label>Last Engine Maintenance:
                    <input type="date" name="engineMaintenance" value={maintenanceData.engineMaintenance} onChange={handleChange} />
                </label>
                <label>Last Tire Check:
                    <input type="date" name="tireCheck" value={maintenanceData.tireCheck} onChange={handleChange} />
                </label>
                <label>Current Mileage (in km):
                    <input type="number" name="currentMileage" value={currentMileage} onChange={handleMileageChange} />
                </label>
            </form>
